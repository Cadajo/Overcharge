...
Shader "Hidden/CRT"
{
	Properties
	{
		...
		// -2.0 = soft
		// -4.0 = hard
		hardPix("HardPix", Range(-2, -4)) = -4
		maskDark("maskDark", Range(0, 2)) = 1.03
		maskLight("maskLight", Range(0, 2)) = 1.8
		// Display warp.
		// 0.0 = none
		// 1.0/8.0 = extreme
		warp("Warp", Vector) = (0, 0, 0, 0)
		// resolution scale
		resScale("ResolutionScale", Range(1, 16)) = 1
	}
		SubShader
	{
		// No culling or depth
